...
public interface AlunoDAO extends CrudRepository<Aluno, Integer> {
	...
	// @Query("select new Aluno(a.nome, a.cpf, a.nroKit, a.turma,
	// a.conta.numero, a.conta.agencia, a.email, "
	// + "a.dataNascimento, a.sexo from Aluno a where a.status = ?1 order by
	// a.nome)")
